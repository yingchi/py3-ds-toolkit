...
| random.sample: Get n Random Elements From a List | [link](https://mathdatasimplified.com/2021/09/09/random-sample-get-n-random-elements-from-a-list/) | [link](https://github.com/khuyentran1401/Python-data-science-code-snippet/blob/master/code_snippets/python/random_sample.py)
...
| Set Difference: Find the Difference Between 2 Sets | [link](https://mathdatasimplified.com/2021/08/26/set-difference-find-the-difference-between-2-sets/) | [link](https://github.com/khuyentran1401/Python-data-science-code-snippet/blob/master/code_snippets/python/set_difference.py)
